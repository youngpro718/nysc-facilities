...
export function AdvancedSearchPanel({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': return 'bg-green-100 dark:bg-green-900/30 text-green-800';
      case 'maintenance': return 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800';
      case 'inactive': return 'bg-red-100 dark:bg-red-900/30 text-red-800';
                ...
                <div
                  ...
                  className={`p-3 rounded-lg border cursor-pointer transition-all hover:shadow-md ${
                    selectedObjects.includes(obj.id)
                      ? 'border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 dark:border-blue-700 dark:bg-blue-900/20'
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      <div className="p-1.5 bg-slate-100 dark:bg-slate-800/30 dark:bg-slate-700 rounded">
