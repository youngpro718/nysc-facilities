...
export function EditTermDialog({ term, open, onClose, onSuccess }: EditTermDialogProps) {
  const { updateTerm, isUpdating } = useTerms();
  ...
  return (
    <Dialog open={open} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Edit Court Term</DialogTitle>
          <DialogDescription>
            Update the information for this court term.
          </DialogDescription>
        </DialogHeader>
