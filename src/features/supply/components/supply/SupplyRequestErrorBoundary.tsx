...
interface SupplyRequestErrorBoundaryProps {
  children: ReactNode;
  fallback?: ReactNode;
...
export class SupplyRequestErrorBoundary extends Component<SupplyRequestErrorBoundaryProps, State> {
  constructor(props: SupplyRequestErrorBoundaryProps) {
    super(props);
