...
import { useLightingTemplates, useCreateFixturesFromTemplate } from '@features/lighting/hooks/useLightingTemplates';
import { LightingTemplate } from '@features/lighting/types/lightingTemplates';
import {
  Dialog,
  DialogContent,
  DialogDescription,
