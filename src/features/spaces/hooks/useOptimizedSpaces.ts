...
const CACHE_CONFIG = {
  ...
  dashboard: { staleTime: 4 * 60 * 1000, gcTime: QUERY_CONFIG.gc.medium },
  hierarchy: { staleTime: 4 * 60 * 1000, gcTime: QUERY_CONFIG.gc.medium },
  details: { staleTime: 2 * 60 * 1000, gcTime: QUERY_CONFIG.gc.short },
  search: { staleTime: QUERY_CONFIG.stale.realtime, gcTime: 2 * 60 * 1000 },
} as const;
