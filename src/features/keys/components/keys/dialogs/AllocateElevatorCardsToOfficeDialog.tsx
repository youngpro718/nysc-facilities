...
interface AllocateElevatorCardsToOfficeDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  officeName?: string; // defaults to Captain's Office
}

export default function AllocateElevatorCardsToOfficeDialog({ open, onOpenChange, officeName = "Captain's Office" }: AllocateElevatorCardsToOfficeDialogProps) {
