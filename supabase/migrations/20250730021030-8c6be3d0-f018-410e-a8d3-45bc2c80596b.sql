-- Fix remaining Security Definer Views - Simple version with minimal columns
...
-- Recreate personnel_profiles_view without SECURITY DEFINER (minimal)
...
-- Recreate spaces view without SECURITY DEFINER (minimal)
...
-- Recreate court_maintenance_view without SECURITY DEFINER (minimal)
...
-- Recreate user_verification_view without SECURITY DEFINER (minimal columns only)
