...
-- Step 1: Drop ALL RLS policies on user_roles table
...
DROP POLICY IF EXISTS "Admins can assign roles with validation" ON public.user_roles;
DROP POLICY IF EXISTS "Admins can update roles with validation" ON public.user_roles;
